            ...
            <div className="max-w-6xl mx-auto">
                ...
                >
                    ...
                    <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                        ...
                        комплексных веб-приложений. Специализируюсь на
                        разработке современных интерфейсов с использованием
                        React, TypeScript и других передовых технологий.
                    </p>
                </motion.div>
                ...
                >
                    ...
                    <p className="text-gray-300 mb-4">
                        ...
                        учебы глубоко погрузился в мир веб-разработки и нашел
                        свое призвание в создании пользовательских интерфейсов.
                    </p>
                    <p className="text-gray-300">
                        Имею опыт коммерческой разработки в различных компаниях,
                        где участвовал в создании корпоративных порталов и
                        систем страхования. Постоянно изучаю новые технологии и
                        подходы, чтобы создавать лучшие продукты.
                    </p>
                </motion.div>
            </div>
        </section>
