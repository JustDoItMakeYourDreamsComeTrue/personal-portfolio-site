      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="mt-8">
              <h4 className="text-xl font-semibold text-white mb-4">Социальные сети</h4>
          ...
          >
            <h3 className="text-2xl font-semibold text-white mb-6">Напишите мне</h3>
        ...
        >
          <p>© 2026 Денис Солодкий. Все права защищены.</p>
        </motion.div>
      </div>
    </section>
  );
